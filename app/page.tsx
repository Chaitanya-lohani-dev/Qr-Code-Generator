...
import {
  ...
  ChartBarIcon,
  ArrowRightIcon,
  ChevronDownIcon, // Naya icon FAQ ke liye
} from "@heroicons/react/24/outline";

export default function HomePage() {
  return (
    // SEO (Metadata) ab app/layout.tsx se handle ho raha hai, isliye yahan <Head> ki zaroorat nahi hai.
    <main className="isolate bg-slate-50">
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
              <div className="group relative flex flex-col rounded-xl bg-white p-8 shadow-lg ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 min-h-[220px]">
                ...
                <dd className="mt-4 text-base leading-7 text-slate-600">
                  Paste any valid URL and get a high-quality QR code in seconds.
                </dd>
              </div>
              ...
              <div className="group relative flex flex-col rounded-xl bg-white p-8 shadow-lg ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 min-h-[220px]">
                ...
                <dd className="mt-4 text-base leading-7 text-slate-600">
                  All your QR codes are saved in your dashboard for easy tracking.
                </dd>
              </div>
              ...
              <div className="group relative flex flex-col rounded-xl bg-white p-8 shadow-lg ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 min-h-[220px]">
                ...
                <dd className="mt-4 text-base leading-7 text-slate-600">
                  Your data is encrypted and always tied to your private account.
                </dd>
              </div>
              ...
              <div className="group relative flex flex-col rounded-xl bg-white p-8 shadow-lg ring-1 ring-slate-900/5 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 min-h-[220px]">
                ...
                <dd className="mt-4 text-base leading-7 text-slate-600">
                  Track how many times your QR codes are scanned with rich insights.
                </dd>
              </div>
            </dl>
          </div>
      ...
      <div id="testimonials" className="bg-gradient-to-b from-slate-50 to-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              { name: "John Doe", role: "Small Business Owner", text: "This tool simplified QR tracking for my shop — quick and reliable.", img: "https://i.pravatar.cc/150?img=1" },
              { name: "Sarah Lee", role: "Event Manager", text: "Managing event check-ins with QR Tracker was a breeze. Highly recommend!", img: "https://i.pravatar.cc/150?img=2" },
              { name: "Mike Patel", role: "Freelancer", text: "Finally a QR tool that gives me both design + analytics. Love it!", img: "https://i.pravatar.cc/150?img=3" },
            ].map((t, i) => (
              <div key={i} className="flex flex-col items-center rounded-2xl bg-white p-6 shadow-lg ring-1 ring-slate-900/5 transition-all hover:shadow-2xl">
                <img src={t.img} alt={t.name} className="h-16 w-16 rounded-full object-cover" />
                <p className="mt-4 text-base text-slate-700 italic">“{t.text}”</p>
      ...
      <div id="faq" className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mt-16 max-w-3xl mx-auto divide-y divide-slate-200">
            {[
              { q: "What is QR Tracker?", a: "QR Tracker lets you create QR codes instantly and track scans in real time, all in one dashboard." },
              { q: "Is there a free plan?", a: "Yes! You can create and manage QR codes for free. Advanced analytics will be available in premium plans." },
              { q: "Do I need to install an app?", a: "No app needed. Everything works in your browser, across devices." },
              { q: "Can I customize my QR codes?", a: "Customization options like colors, logos, and styles are on our roadmap." },
              { q: "How secure is my data?", a: "All data is encrypted and tied securely to your Clerk account." },
            ].map((faq, i) => (
        ...
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-white px-6 py-24 text-center shadow-2xl rounded-2xl sm:px-16 ring-1 ring-slate-900/5">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <SignedOut>
                <Link href="/sign-up" className="rounded-md bg-gradient-to-r from-cyan-500 to-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-lg hover:from-cyan-600 hover:to-blue-700 transition-all transform hover:scale-105">
                  Sign up for free <ArrowRightIcon className="inline h-4 w-4 ml-2" />
                </Link>
              </SignedOut>
              <SignedIn>
                <Link href="/dashboard" className="rounded-md bg-gradient-to-r from-cyan-500 to-blue-600 px-5 py-3 text-sm font-semibold text-white shadow-lg hover:from-cyan-600 hover:to-blue-700 transition-all transform hover:scale-105">
